              ...
              <tr>
                <td style={{ width: "100%", textAlign: "center", verticalAlign: "bottom" }}>
                  <div style={{ display: "inline-block", textAlign: "center", width: "15rem" }}>
                    <div style={{ fontWeight: "bold", fontSize: "8.5pt", lineHeight: "1.3", display: "block", marginBottom: "3.5rem" }}>
                      {titleInstructor}
                    </div>
                    ...
                    <div style={{ fontWeight: "bold", fontSize: "9pt", lineHeight: "1.3", display: "block" }}>
                      {police.instructorNombres} {police.instructorApellidos}
                    </div>
                    {police.instructorGrado && (
                      <div style={{ fontSize: "8.5pt", lineHeight: "1.3", display: "block" }}>
                        {police.instructorGrado}
                      </div>
                    )}
                    ...
                    <tbody>
                      <tr>
                        <td style={{ textAlign: "left", verticalAlign: "bottom" }}>
                          <div style={{ fontWeight: "bold", textTransform: "uppercase", fontSize: "8.5pt", lineHeight: "1.3", display: "block", marginBottom: "3.5rem" }} className="uppercase">
                          ...
                          <div style={{ fontWeight: "bold", fontSize: "8.5pt", lineHeight: "1.3", display: "block" }}>
                            {detenido.nombres} {detenido.apellidos}
                          </div>
                        </td>
                          ...
                          <tbody>
                            <tr>
                              <td style={{ textAlign: "left", verticalAlign: "bottom" }}>
                                ...
                                <div style={{ fontWeight: "bold", fontSize: "8.5pt", lineHeight: "1.3", display: "block" }}>
                                  {firstDet.nombres || "_______________"} {firstDet.apellidos || "_________________"}
                                </div>
                              </td>
                              <td style={{ width: "3.5rem", verticalAlign: "bottom", textAlign: "right" }}>
                                <div style={{ width: "3.5rem", height: "4.5rem", border: "1px solid #000000", display: "inline-block" }}></div>
                          ...
                          <tbody>
                            <tr>
                              <td style={{ textAlign: "left", verticalAlign: "bottom" }}>
                                ...
                                <div style={{ fontWeight: "bold", fontSize: "8.5pt", lineHeight: "1.3", display: "block" }}>
                                  {secondDet.nombres || "_______________"} {secondDet.apellidos || "_________________"}
                                </div>
                              </td>
                              <td style={{ width: "3.5rem", verticalAlign: "bottom", textAlign: "right" }}>
                                <div style={{ width: "3.5rem", height: "4.5rem", border: "1px solid #000000", display: "inline-block" }}></div>
          ...
          >
              ...
              >
                {isLoadingImage ? (
                  ...
                  <div className="flex flex-col items-center justify-center py-20 text-center space-y-4 px-6">
                    ...
                    <h3 className="font-bold text-rose-700 text-lg font-sans">Error al Procesar con IA</h3>
                    <div className="bg-rose-50 border border-rose-200 text-rose-800 rounded-xl p-4 text-xs max-w-lg font-sans leading-relaxed text-justify shadow-sm">
                      {cargoError}
                    </div>
                    <p className="text-xs text-slate-400 font-sans">Verifique su conexión o la clave de API y vuelva a intentarlo.</p>
                  </div>
                ) : customA4Html ? (
                  ...
                  <div className="detencion-firmas" style={{ display: "flex", justifyContent: "space-between", alignItems: "stretch", marginTop: "30px", gap: "10px" }}>
                    ...
                    <div style={{ width: "38%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between", textAlign: "center" }}>
                      <div style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", width: "100%" }}>
                        <span style={{ fontWeight: "bold", fontSize: "9.5pt", display: "block", marginBottom: "3.5rem" }}>EL INSTRUCTOR PNP</span>
                        ...
                        <div style={{ width: "100%" }}>
                          ...
                          <div style={{ fontSize: "9pt", lineHeight: "1.2" }}>
                            ...
                            <span style={{ display: "block", fontWeight: "bold", textTransform: "uppercase" }}>{police.instructorNombres || "__________________"} {police.instructorApellidos || "__________________"}</span>
                            <span style={{ display: "block", fontSize: "8pt" }}>{police.instructorGrado || "______"}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <tr>
                      ...
                      <td style={{ width: "31%", textAlign: "center", verticalAlign: "bottom", paddingRight: "5px" }}>
                        <div style={{ display: "inline-block", textAlign: "center", width: "100%" }}>
                          <div style={{ fontWeight: "bold", display: "block", marginBottom: "3.5rem" }}>EL INSTRUCTOR PNP</div>
                          <div style={{ borderTop: "1px solid black", marginBottom: "3px" }}></div>
                          <div style={{ display: "block" }}>CIP N° {police.instructorCIP}</div>
                          <div style={{ fontWeight: "bold", display: "block" }}>{police.instructorNombres} {police.instructorApellidos}</div>
                          <div style={{ display: "block" }}>{police.instructorGrado}</div>
                        </div>
                      </td>
                      ...
                      <td style={{ width: "34.5%", verticalAlign: "bottom", paddingLeft: "5px", paddingRight: "5px" }}>
                        <table style={{ width: "100%", borderCollapse: "collapse" }}>
                          <tbody>
                            <tr>
                              <td style={{ textAlign: "left", verticalAlign: "bottom" }}>
                                <div style={{ fontWeight: "bold", display: "block", marginBottom: "3.5rem" }}>EL ADOLESCENTE {detenido.tipo === "RETENIDO" ? "RETENIDO" : detenido.tipo === "INTERVENIDO" || detenido.tipo === "PERSONA" ? "INTERVENIDO" : "DETENIDO"}</div>
                                <div style={{ borderTop: "1px solid black", width: "95%", marginBottom: "3px" }}></div>
                                <div style={{ display: "block" }}>DNI N° {detenido.dni}</div>
                                <div style={{ fontWeight: "bold", display: "block" }}>{detenido.nombres} {detenido.apellidos}</div>
                              </td>
                      ...
                      <td style={{ width: "34.5%", verticalAlign: "bottom", paddingLeft: "5px" }}>
                        <table style={{ width: "100%", borderCollapse: "collapse" }}>
                          <tbody>
                            <tr>
                              <td style={{ textAlign: "left", verticalAlign: "bottom" }}>
                                <div style={{ fontWeight: "bold", display: "block", marginBottom: "3.5rem" }}>EL RESPONSABLE / TUTOR (Vínculo: {state.detencionMenor.contactoPadreVinculo || "_______"})</div>
                                <div style={{ borderTop: "1px solid black", width: "95%", marginBottom: "3px" }}></div>
                                <div style={{ display: "block" }}>DNI N° {state.detencionMenor.contactoPadreDni || "______"}</div>
            ...
            {currentDocId === "lacradoArma" && (
              <div className="custom-font" style={{ fontFamily: "monospace", color: "#000000", backgroundColor: "#ffffff", padding: "10px", margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
                ...
                <div style={{ marginTop: "60px", display: "flex", justifyContent: "space-between", padding: "0 40px", fontSize: "12px", fontFamily: "monospace" }}>
                  <div style={{ textAlign: "center", width: "200px" }}>
                    <span style={{ fontWeight: "bold", textTransform: "uppercase", display: "block", marginBottom: "3.5rem" }}>
                      {getUpperLabelForTipo(detenido.tipo)}
                    </span>
                    <div style={{ borderTop: "1px solid #000000", marginBottom: "10px" }}></div>
                    <span style={{ display: "block", fontSize: "10px" }}>DNI N° {detenido.dni}</span>
                    {detenido.nombres && (
                      <span style={{ fontWeight: "bold", display: "block", fontSize: "10px", textTransform: "uppercase" }}>{detenido.nombres} {detenido.apellidos}</span>
                    )}
                  </div>
                  ...
                  <div style={{ textAlign: "center", width: "200px" }}>
                    ...
                    <div style={{ borderTop: "1px solid #000000", marginBottom: "10px" }}></div>
                    <span style={{ display: "block", fontSize: "10px" }}>CIP N° {police.instructorCIP}</span>
                    {police.instructorApellidos && (
                      <span style={{ fontWeight: "bold", display: "block", fontSize: "10px", textTransform: "uppercase" }}>{police.instructorNombres} {police.instructorApellidos}</span>
                    )}
                    {police.instructorGrado && (
                      <span style={{ display: "block", fontSize: "10px" }}>{police.instructorGrado}</span>
                    )}
                  </div>
                </div>
              </div>
